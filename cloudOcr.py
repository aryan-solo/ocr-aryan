...
class CloudOCR:
	...
	def process_and_download(self, file, timeout=300, delay_between_status_check=1, **kwargs):
		...
		result = self.wait_for_task(task, delay_between_status_check, timeout=timeout)
	...
	def download(self, task, delay_between_status_check, timeout):
		formats='xml'
		formats = formats.split(',')
